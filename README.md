...
- `src/datastar.ts` — typed signal/action/attribute helpers for generating/composing Datastar expressions and action URLs, validating signal names, merging attributes, object-form bindings, modifier suffixes, and `data-*` attributes.
