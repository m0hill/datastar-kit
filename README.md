...
- `src/datastar.ts` — typed signal/action/attribute helpers for generating/composing Datastar expressions, validating signal names, merging attributes, modifier suffixes, and `data-*` attributes.
