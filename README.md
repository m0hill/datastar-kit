...
- `src/datastar.ts` — typed signal/action/attribute helpers for generating Datastar expressions, validating signal names, merging attributes, modifier suffixes, and `data-*` attributes.
