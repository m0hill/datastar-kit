...
7. [Realtime streams](guides/realtime.md) — app-owned live query recipes with `reply.stream(...)`.

### 3. Operations

8. [Security](guides/security.md) — auth, CSRF, ownership checks, and safe navigation boundaries.
9. [Deployment](guides/deployment.md) — runtime adapters, Datastar assets, SSE proxy settings, and smoke tests.
10. [Testing](guides/testing.md) — request/response tests, protocol tests, and browser-runtime tests.
11. [Examples](guides/examples.md) — workspace examples and what they demonstrate.
